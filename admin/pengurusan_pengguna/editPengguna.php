      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form method="POST" action="" name="editFormUser"><br>
                      ...
                      <div class="mt-2">
                        <div align="right">
                          <button type="button" class="btn btn-outline-secondary" onclick="location.href='../../admin/pengurusan_pengguna/pengguna.php'"><span class="tf-icons bx bx-x"></span>&nbsp;Batal</button>
          ...
          if (isset($_POST['editUser'])) {
            ...
            if (!$sameIC) {
              if ($ed_US == 0) {
                $sqlUR = "SELECT * FROM userroles WHERE USER_CODE=$editID";
                ...
                if ($queryUR) {
                  ...
                  if ($isUR) {
                    echo '<script>swal({
                  title: "Ralat!",
                  text: "Maklumat Pengguna masih digunakan dalam peranan capaian pengguna!",
                  icon: "error",
                  });
                  </script>';
                  } else {
              ...
              if ($isProceed) {
                ...
                if ($query) {
                  echo '<script>swal({
                          ...
                          document.location ="../../admin/pengurusan_pengguna/pengguna.php";
                        });
                        </script>';
                } else {
                  echo '<script>swal({
