  ...
  <script>
    function toExcel() {
      $("#tableD").table2excel({
        ...
        name: "Worksheet Name",
        filename: "Senarai Peranan.xls", // do include extension
    ...
    function toPDF() {
      html2canvas($('#tableD')[0], {
        onrendered: function(canvas) {
          ...
          pdfMake.createPdf(docDefinition).download("Senarai Peranan.pdf");
        }
      });
    }
  </script>
        ...
        <div class="content-wrapper">
          ...
          <div class="modal fade" id="addRoleModal" data-bs-backdrop="static" tabindex="-1">
            <div class="modal-dialog">
              <form class="modal-content" name="formRole" id="formRole" action="" method="POST">
                ...
                <div class="modal-body">
                  <div class="row">
                    <div class="col mb-3">
                      <label for="inModulName" class="form-label">Nama Peranan</label>
                      <input style="text-transform:uppercase" type="text" id="inRoleName" name="inRoleName" class="form-control" placeholder="CONTOH : PENYEDIA" required />
                    </div>
                  </div>
                </div>
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary" name="addRole">Tambah</button>
                </div>
              </form>
              ...
              if (isset($_POST['addRole'])) {
                ...
                $roleN = strtoupper($_POST['inRoleName']);
                $roleD = $date;
                ...
                if ($isRoleExist) {
                  ...
                  $sql = "INSERT INTO roles (ROLE_NAME,ROLE_STATUS,ROLE_DATE) VALUES ('$roleN',1,'$roleD')";
                  ...
                  if ($query) {
                    echo '<script>swal({
                    title: "Berjaya!",
                    text: "Maklumat Peranan berjaya ditambah",
                    type: "success",
                    icon: "success",
                    });
                    </script>';
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
              <div class="col mb-4 order-0">
                <!-- Striped Rows -->
                <h4 class="fw-bold py-3 mb-4">Peranan</h4>

                <div class="card">

                  <h5 class="card-header d-flex justify-content-between align-items-center">Senarai Peranan
                    <div class="demo-inline-spacing">
                      ...
                      <button data-bs-toggle="modal" data-bs-target="#addRoleModal" type="button" class="btn btn-primary">
                        <span class='bx bxs-add-to-queue'></span>&nbsp; Tambah Peranan
                      </button>
                    </div>
                  </h5>
                  <br>
                      ...
                      <tbody class="table-border-bottom-0">
                        ...
                        function showData($conn)
                        {
                          ...
                          foreach ($query as $row) {
                                ...
                                <td>
                                  <div class='dropdown'>
                                    ...
                                    <div class='dropdown-menu'>
                                      <a class='dropdown-item' href='editRole.php?role_edit_id={$row['ROLE_CODE']}'><i class='bx bx-edit-alt me-1'></i> Ubah</a>

                                      <a class='dropdown-item' href='#' onclick='updateStatus({$row['ROLE_CODE']});'><i class='bx bx-check'></i>  Aktif</a>
                                    </div>
                                  </div>
                                </td>
																</tr>\n";
                                ...
                                <td>
                                  <div class='dropdown'>
                                    ...
                                    <div class='dropdown-menu'>
                                      ...
                                      <a class='dropdown-item' href='#' onclick='updateStatus({$row['ROLE_CODE']});'><i class='bx bx-x'></i>  Tidak Aktif</a>
                                    </div>
                                  </div>
                                </td>
																</tr>\n";
                            ...
                            // echo "                                      <a onclick='return confirmDelete(this);' class='dropdown-item' href='deleteRole.php?role_delete_id={$row['ROLE_CODE']}'><i class='bx bx-trash me-1'></i> Delete</a>";
                          }
                          if ($i == 0) {
                            echo "<tr><td style='text-align:center; vertical-align:middle' colspan='5'><br><h4>No Data<h4><br></td></tr>";
                          }
                        }
                        showData($conn);
