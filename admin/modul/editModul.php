...
<head>
  ...
  <title>Kemas Kini Modul | Admin</title>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="POST" action="" name="editFormModul">
                        ...
                        <div align="right">
                          <button type="button" id="bModul" name="bModul" class="btn btn-outline-secondary" onclick="location.href='../../admin/modul/modul.php'">
                      ...
                      if (isset($_POST['editModul'])) {
                        ...
                        if ($queryM) {
                          foreach ($queryM as $row) {
                            if ($ed_MN == $row['MODULE_NAME'] || $ed_MP == $row['MODULE_PREFIX']) {
                              $isSameModule = true;
                              if ($ed_MS == $row['MODULE_STATUS']) {
                                $isChange = false;
                              }
                              break;
                            }
                        ...
                        if (!$isChange) {
                          // if (!$isSameModule ) {
                            if ($ed_MS == 0) {
                              $sqlMM = "SELECT * FROM usermatrix WHERE MODULE_CODE='$editID'";
                              $queryMM = mysqli_query($conn, $sqlMM);
                              $isMM = false;
                              if ($queryMM) {
                                ...
                                if ($isMM) {
                                  echo '<script>swal({
                                title: "Ralat!",
                                text: "Maklumat modul masih digunakan dalam peranan capaian pengguna!",
                                icon: "error",
                                });
                                </script>';
                                } else {
                            ...
                            if ($isProceed) {
                              ...
                              document.location ="../../admin/modul/modul.php";
                              });
                            </script>';
                              } else {
                                echo '<script>swal({
                              ...
                              echo '<script>swal({
                            title: "Ralat!",
                            text: "Nama atau Singkatan Modul telah wujud!",
                            icon: "error",
                            });
                            </script>';
                            }
                        ...
                        //   echo '<script>swal({
                        //     title: "Ralat!",
                        //     text: "Maklumat modul telah wujud!",
                        //     icon: "error",
                        //     });
                        //     </script>';
                        // }
