...
<head>
  ...
  <title>Capaian Pengguna | Admin</title>
      ...
      $.ajax({
        ...
        success: function(data) {
          if (data == 3) {
            ...
            swal("Ralat!", "Maklumat Capaian Pengguna masih digunakan dalam peranan capaian pengguna", "error");
          } else if(data == 4){
            swal("Ralat!", "Status Capaian Pengguna tidak berjaya ditukar!", "error");
          }
        }
      });
