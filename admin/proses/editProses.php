...
<head>
  ...
  <title>Kemas Kini Proses | Admin</title>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="POST" action="" name="editFormProses">
                        ...
                        <div align="right">
                          <button type="button" id="bProses" name="editProses" class="btn btn-outline-secondary" onclick="location.href='../../admin/proses/proses.php'">
                      ...
                      if (isset($_POST['editProses'])) {
                        ...
                        if ($query) {
                          ...
                          document.location ="../../admin/proses/proses.php";
                        });
                        </script>';
                        } else {
                          echo '<script>swal({
