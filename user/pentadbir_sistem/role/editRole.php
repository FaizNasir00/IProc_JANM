...
<head>
  ...
  <title>Kemas Kini Peranan | PS</title>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="POST" action="" name="editFormPeranan">
                        ...
                        <div align="right">
                          <button type="button" id="bRole" name="bRole" class="btn btn-outline-secondary" onclick="location.href='../../pentadbir_sistem/role/role.php'">
                      ...
                      if (isset($_POST['editRole'])) {
                        ...
                        if($query){
                          ...
                          document.location ="../../pentadbir_sistem/role/role.php";
                        });
                        </script>';
