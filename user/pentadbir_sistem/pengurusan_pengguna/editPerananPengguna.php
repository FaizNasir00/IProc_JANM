        ...
        <div class="content-wrapper">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form action="" name="editURForm" method="POST">
                      ...
                      <div class="mt-2">
                        <div align="right">
                          <button type="button" class="btn btn-outline-secondary" onclick="location.href='../../pentadbir_sistem/pengurusan_pengguna/pengguna.php'"><span class="tf-icons bx bxs-x"></span>&nbsp;Batal</button>
          ...
          if (isset($_POST['editUserRole'])) {
            ...
            echo '<script>swal({
                  ...
                  document.location ="../../pentadbir_sistem/pengurusan_pengguna/pengguna.php"; }); </script>';
