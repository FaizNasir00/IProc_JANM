...
<head>
  ...
  <title>Kemas Kini Capaian Pengguna | PS</title>
                    ...
                    <div class="card-body">
                      <form method="POST" action="" name="editFormProses">
                        ...
                        <div align="right">
                          ...
                          <button type="button" id="bProses" name="editProses" class="btn btn-outline-secondary" onclick="location.href='../../pentadbir_sistem/capaian_pengguna/capaian_pengguna.php'">
                        ...
                        if ($queryUS) {
                          ...
                          if (!$isCPExist) {
                            ...
                            if ($query) {
                              ...
                              document.location ="../../pentadbir_sistem/capaian_pengguna/capaian_pengguna.php";
                              });
                              </script>';
                            } else {
                              echo '<script>swal({
