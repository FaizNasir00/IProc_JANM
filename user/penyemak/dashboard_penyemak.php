...
$sqlPro = "SELECT * FROM processes";
$queryPro = mysqli_query($conn, $sqlPro);
$userP = 0;

if ($queryPro) {
  foreach ($queryPro as $row) {
    $userP++;
  }
} else {
  echo "<script>alert('Data Query Error')</script>";
...
<head>
  ...
  <title>Paparan Utama | Pennyedia</title>
    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme"><br>
        <div class="app-brand demo">
          <a href="../penyemak/dashboard_penyemak.php" class="app-brand-link">
        ...
        <ul class="menu-inner py-1">
          <li class="menu-item active">
            <a href="../penyemak/dashboard_penyemak.php" class="menu-link">
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              ...
              <li class="nav-item lh-1 me-3">
                <a class="github-button" href="#" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star themeselection/sneat-html-admin-template-free on GitHub">Penyemak</a>
              </li>
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <div class="avatar avatar-online">
                    <img src="../../assets/img/avatars/user9.png" alt class="w-px-40 h-auto rounded-circle" />
                  </div>
                </a>
                    ...
                    <a class="dropdown-item" href="#">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <span class="fw-semibold d-block">Penyemak</span>
              ...
              <div class="col-lg-8 mb-4 order-0">
                <div class="card">
                  <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                      <div class="card-body">
                        <h5 class="card-title text-primary">Sistem 30% Siap 🎉</h5>
                        <p class="mb-4">
                          Sistem untuk pengguna <span class="fw-bold">30%</span> berfungsi dengan lengkap. Sila pastikan semua data tersedia.
                        </p>

                        <a href="https://wa.link/zpjqqh" class="btn btn-sm btn-outline-primary">Hubungi Kami</a>
                      </div>
                    </div>
                      ...
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img src="../../assets/img/icons/unicons/cc-modul.png" alt="chart success" class="rounded" />
                          </div>
                          <!-- <div class="dropdown">
                        ...
                        <h3 class="card-title mb-2"><?= $userM ?></h3>
                  ...
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img src="../../assets/img/icons/unicons/cc-proses.png" alt="Credit Card" class="rounded" />
                          </div>
                          <!-- <div class="dropdown">
                        ...
                        <span class="fw-semibold d-block mb-1">Jumlah Proses</span>
                  ...
                  <div class="col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img src="../../assets/img/icons/unicons/cc-user.png" alt="Credit Card" class="rounded" />
                          </div>
                          <!-- <div class="dropdown">
                        ...
                        <span class="d-block mb-1">Jumlah Pengguna</span>
                        <h3 class="card-title text-nowrap mb-2"><?= $userC ?></h3>
                  ...
                  <div class="col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img src="../../assets/img/icons/unicons/cc-um.png" alt="Credit Card" class="rounded" />
                          </div>
                          <!-- <div class="dropdown">
                        ...
                        <span class="fw-semibold d-block mb-1">Jumlah Capaian Pengguna</span>
                        <h3 class="card-title mb-2"><?= $userUS ?></h3>
          ...
          <footer class="content-footer footer bg-footer-theme">
            <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
              <div class="mb-2 mb-md-0">
                ...
                , made with ❤️ by
                <a href="" target="_blank" class="footer-link fw-bolder">Jabatan Akauantan Negara Malaysia</a>
              </div>
            </div>
          </footer>
          <!-- / Footer -->
