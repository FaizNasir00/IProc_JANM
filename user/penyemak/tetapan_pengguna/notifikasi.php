    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme"><br>
        ...
        <ul class="menu-inner py-1">
          <li class="menu-item">
            <a href="../user/pentadbir_sistem/dashboard_ps.php" class="menu-link">
          ...
          <li class="menu-item active">
            <a href="../user/profail_ps.php" class="menu-link">
              <i class="menu-icon tf-icons bx bxs-detail"></i>
            ...
            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i> Akauan</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href='tetapan.php?user_edit_id=<?= $editID ?>'><i class="bx bx-cog"></i> Tetapan</a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form method="POST" action="" name="editFormUser"><br>
                      <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" class="form-control" id="edPName" name="edPName" placeholder="CONTOH : ALI BIN ABU" value="<?= $valueNAME ?>" required />
                          </div>
                        </div>
                        <div class="mb-3 col-md-6">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="edPPos" name="edPPos" class="form-control" placeholder="CONTOH : PEN PEGAWAI KESIHATAN" value="<?= $valuePOS ?>" required />
                          </div>
                        </div>
                        <div class="mb-3 col-md-6">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input type="text" id="edPGrade" name="edPGrade" class="form-control" placeholder="CONTOH : FA29" aria-label="FA29" value="<?= $valueGRADE ?>" required />
                          </div>
                        </div>
                        <div class="mb-3 col-md-6">
                      ...
                      <div class="mt-2">
                        <div align="right">
                          <button type="button" class="btn btn-outline-secondary" onclick="location.href='../user/profail_user.php'"><span class="tf-icons bx bx-x"></span>&nbsp;Batal</button>
