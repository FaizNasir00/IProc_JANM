            ...
            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  <li class="nav-item">
                    <a class="nav-link" href='akaun.php?user_edit_id=<?= $editID ?>'><i class="bx bx-user me-1"></i> Akaun</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href='tetapan.php?user_edit_id=<?= $editID ?>'><i class="bx bx-cog"></i> Tetapan</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href='notifikasi.php?user_edit_id=<?= $editID ?>'><i class="bx bx-bell me-1"></i> Notifikasi</a>
                  </li>
                </ul>
              </div>
            </div>
