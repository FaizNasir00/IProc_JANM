            ...
            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                  <li class="nav-item">
                    <a class="nav-link active" href="javascript:void(0);"><i class="bx bx-user me-1"></i> Akaun</a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <form method="POST" action="" name="editFormUser"><br>
                      ...
                      <div class="mt-2">
                        <div align="right">
                          <button type="button" class="btn btn-outline-secondary" onclick="location.href='../dashboard_pelulus.php'"><span class="tf-icons bx bx-x"></span>&nbsp;Batal</button>
